(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-login-login-module"], {
    ...
    /***/
    function srcAppPagesLoginServiceTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function srcAppPagesLoginLoginModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      LoginPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], _angular_router__WEBPACK_IMPORTED_MODULE_7__["RouterModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_8__["HttpClientModule"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _login_routing_module__WEBPACK_IMPORTED_MODULE_5__["LoginPageRoutingModule"]],
    ...
    function srcAppPagesLoginLoginPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var LoginPage = /*#__PURE__*/function () {
        function LoginPage(formBuilder, loading, router, loginService, platform, routerOutlet, modalController) {
        ...
        _createClass(LoginPage, [{
          ...
          value: function login() {
            ...
            this.loginService.login(this.loginForm.value.email, this.loginForm.value.password).subscribe(function (data) {
              _this.userDetails = data; //console.log(data.user);

              _this.loading.dismiss();

              if (_this.userDetails.user) {
                localStorage.setItem('user', JSON.stringify({
                  user: _this.userDetails.user,
                  token_type: _this.userDetails.token_type,
                  access_token: _this.userDetails.access_token
                }));
              ...
              if (_this.userDetails.error) {
                _this.loading.dismiss();

                _this.loading.presentToastWarning(_this.userDetails.error);
              }
            }, function (onerror) {
              if (onerror.status == 0) {
