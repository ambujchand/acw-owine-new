...
let EmployeeService = class EmployeeService {
    ...
    addEmployee(postData) {
        ...
        return this.http.post(this.env.API_URL + 'bar-owner/register', postData, { headers: headers })
    ...
    getEmployeeDetails(postData) {
        ...
        return this.http.post(this.env.API_URL + 'bar-owner/employee', postData, { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(user => {
            return user;
        }));
    }
    deleteEmployee(postData) {
        ...
        return this.http.post(this.env.API_URL + 'bar-owner/delete-employee', postData, { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(user => {
            return user;
        }));
    }
...
let InvoiceService = class InvoiceService {
    ...
    getInvoice(postData) {
        ...
        return this.http.post(this.env.API_URL + 'bar-owner/getInvoice', postData, { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(user => {
            return user;
        }));
    }
    invoiceGenerateDetails(postData) {
        ...
        return this.http.post(this.env.API_URL + 'bar-owner/showInvoice', postData, { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(user => {
            return user;
        }));
    }
...
let OrderService = class OrderService {
    ...
    getAllResentOrders() {
        ...
        return this.http.get(this.env.API_URL + 'order/allProgressOrders', { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(user => {
            return user;
        }));
    }
    getOrderStatus(formData) {
        ...
        return this.http.post(this.env.API_URL + 'order/order-status', formData, { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(user => {
            return user;
        }));
    }
...
let ProductService = class ProductService {
    ...
    getCategoryProductDetails(postData) {
        ...
        return this.http.post(this.env.API_URL + 'bar-owner/purchase', postData, { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(user => {
            return user;
        }));
    }
    catalogueProducts(postData) {
        ...
        return this.http.post(this.env.API_URL + 'bar-owner/catalogueProducts', postData, { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(user => {
            return user;
        }));
    }
    getProductDetails(postData) {
        ...
        return this.http.post(this.env.API_URL + 'bar-owner/inventoryProducts', postData, { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(user => {
            return user;
        }));
    }
    placeOrder(postData) {
        ...
        return this.http.post(this.env.API_URL + 'order/store', postData, { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(user => {
            return user;
        }));
    }
    getCategoryProducts() {
        ...
        return this.http.get(this.env.API_URL + 'bar-owner/productDetails', { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(user => {
            return user;
        }));
    }
    addNewProduct(postData) {
        ...
        return this.http.post(this.env.API_URL + 'bar-owner/addProduct', postData, { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(user => {
            return user;
        }));
    }
    addCustomProduct(postData) {
        ...
        return this.http.post(this.env.API_URL + 'bar-owner/addCustomProduct', postData, { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(user => {
            return user;
        }));
    }
    getCategorDetails() {
        ...
        return this.http.get(this.env.API_URL + 'bar-owner/addProduct', { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(user => {
            return user;
        }));
    }
    getInventoryDetails(postData) {
        ...
        return this.http.post(this.env.API_URL + 'bar-owner/showProducts', postData, { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(user => {
            return user;
        }));
    }
    getCategoryList() {
        ...
        return this.http.get(this.env.API_URL + 'bar-owner/categories', { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(user => {
            return user;
        }));
    }
    getAllInventoryOrders() {
        ...
        return this.http.get(this.env.API_URL + 'order/allOrders', { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(user => {
            return user;
        }));
    }
    deleteProduct(postData) {
        ...
        return this.http.post(this.env.API_URL + 'bar-owner/delete-product', postData, { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(user => {
            return user;
        }));
    }
    getProductCatalougeDetails() {
        ...
        return this.http.get(this.env.API_URL + 'bar-owner/catalogueCategories', { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(user => {
            return user;
        }));
    }
    updateSoldQty(postData) {
        ...
        return this.http.post(this.env.API_URL + 'bar-owner/update-qty', postData, { headers: headers })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(user => {
            return user;
        }));
    }
