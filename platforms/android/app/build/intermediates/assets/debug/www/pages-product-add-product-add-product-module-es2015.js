...
let AddProductPage = class AddProductPage {
    ...
    getCategoryProducts() {
        ...
        this.product.getCategoryProducts().subscribe(data => {
            console.log(data);
    ...
    addProduct() {
        console.log(this.addProductForm.value);
        this.loading.present();
        this.product.addNewProduct(this.addProductForm.value).subscribe(data => {
            console.log(data);
            this.loading.dismiss();
...
//# sourceMappingURL=pages-product-add-product-add-product-module-es2015.js.map