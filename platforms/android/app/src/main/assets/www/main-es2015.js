...
var map = {
	...
	"./pages/employee/create-employee/create-employee.module": [
	...
	"./pages/invoice/invoice-details/invoice-details.module": [
		"./src/app/pages/invoice/invoice-details/invoice-details.module.ts",
		"common",
		"pages-invoice-invoice-details-invoice-details-module"
	],
	"./pages/invoice/invoice-generate/invoice-generate.module": [
	...
	"./pages/order/order-details/order-details.module": [
		"./src/app/pages/order/order-details/order-details.module.ts",
		"common",
		"pages-order-order-details-order-details-module"
	],
	"./pages/order/order-list/order-list.module": [
		"./src/app/pages/order/order-list/order-list.module.ts",
		"pages-order-order-list-order-list-module"
	],
	"./pages/order/order-tracking/order-tracking.module": [
		"./src/app/pages/order/order-tracking/order-tracking.module.ts",
		"common",
		"pages-order-order-tracking-order-tracking-module"
	],
	"./pages/order/orders/orders.module": [
		"./src/app/pages/order/orders/orders.module.ts",
		"common",
		"pages-order-orders-orders-module"
	],
	"./pages/product/add-custom-product/add-custom-product.module": [
	...
	"./pages/product/show-catalouge/show-catalouge.module": [
...
/* harmony import */ var _services_auth_guard_guard__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./services/auth-guard.guard */ "./src/app/services/auth-guard.guard.ts");
...
const routes = [
    ...
    { path: 'dashboard', loadChildren: './pages/dashboard/dashboard.module#DashboardPageModule', canActivate: [_services_auth_guard_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuardGuard"]] },
    { path: 'product-catagory', loadChildren: './pages/product/product-catagory/product-catagory.module#ProductCatagoryPageModule', canActivate: [_services_auth_guard_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuardGuard"]] },
    { path: 'product-list', loadChildren: './pages/product/product-list/product-list.module#ProductListPageModule', canActivate: [_services_auth_guard_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuardGuard"]] },
    { path: 'product-details', loadChildren: './pages/product/product-details/product-details.module#ProductDetailsPageModule', canActivate: [_services_auth_guard_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuardGuard"]] },
    { path: 'create-employee', loadChildren: './pages/employee/create-employee/create-employee.module#CreateEmployeePageModule', canActivate: [_services_auth_guard_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuardGuard"]] },
    { path: 'employee-list', loadChildren: './pages/employee/employee-list/employee-list.module#EmployeeListPageModule', canActivate: [_services_auth_guard_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuardGuard"]] },
    { path: 'order-list', loadChildren: './pages/product/order-list/order-list.module#OrderListPageModule', canActivate: [_services_auth_guard_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuardGuard"]] },
    { path: 'order-details', loadChildren: './pages/product/order-details/order-details.module#OrderDetailsPageModule', canActivate: [_services_auth_guard_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuardGuard"]] },
    { path: 'place-order', loadChildren: './pages/product/place-order/place-order.module#PlaceOrderPageModule', canActivate: [_services_auth_guard_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuardGuard"]] },
    { path: 'add-product', loadChildren: './pages/product/add-product/add-product.module#AddProductPageModule', canActivate: [_services_auth_guard_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuardGuard"]] },
    { path: 'add-custom-product', loadChildren: './pages/product/add-custom-product/add-custom-product.module#AddCustomProductPageModule', canActivate: [_services_auth_guard_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuardGuard"]] },
    { path: 'category-list', loadChildren: './pages/product/category-list/category-list.module#CategoryListPageModule', canActivate: [_services_auth_guard_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuardGuard"]] },
    { path: 'current-inventory', loadChildren: './pages/product/current-inventory/current-inventory.module#CurrentInventoryPageModule', canActivate: [_services_auth_guard_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuardGuard"]] },
    { path: 'order-list', loadChildren: './pages/order/order-list/order-list.module#OrderListPageModule', canActivate: [_services_auth_guard_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuardGuard"]] },
    { path: 'order-details-page', loadChildren: './pages/order/order-details/order-details.module#OrderDetailsPageModule', canActivate: [_services_auth_guard_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuardGuard"]] },
    { path: 'order-tracking', loadChildren: './pages/order/order-tracking/order-tracking.module#OrderTrackingPageModule', canActivate: [_services_auth_guard_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuardGuard"]] },
    { path: 'orders', loadChildren: './pages/order/orders/orders.module#OrdersPageModule', canActivate: [_services_auth_guard_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuardGuard"]] },
    { path: 'invoice-details', loadChildren: './pages/invoice/invoice-details/invoice-details.module#InvoiceDetailsPageModule', canActivate: [_services_auth_guard_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuardGuard"]] },
    { path: 'invoice-generate', loadChildren: './pages/invoice/invoice-generate/invoice-generate.module#InvoiceGeneratePageModule', canActivate: [_services_auth_guard_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuardGuard"]] },
    { path: 'show-catalouge', loadChildren: './pages/product/show-catalouge/show-catalouge.module#ShowCatalougePageModule', canActivate: [_services_auth_guard_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuardGuard"]] },
];
...
module.exports = __webpack_require__(/*! C:\GeoAlgo\Ace-Wine\src\main.ts */"./src/main.ts");
