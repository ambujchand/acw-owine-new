(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-product-add-custom-product-add-custom-product-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppPagesProductAddCustomProductAddCustomProductPageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppPagesProductAddCustomProductAddCustomProductRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "AddCustomProductPageRoutingModule", function () {
        return AddCustomProductPageRoutingModule;
      });
      /* harmony import */
      ...
      var _add_custom_product_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      ...
      var AddCustomProductPageRoutingModule = function AddCustomProductPageRoutingModule() {
        _classCallCheck(this, AddCustomProductPageRoutingModule);
      };

      AddCustomProductPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function srcAppPagesProductAddCustomProductAddCustomProductModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "AddCustomProductPageModule", function () {
        return AddCustomProductPageModule;
      });
      /* harmony import */
      ...
      var _add_custom_product_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./add-custom-product-routing.module */
      "./src/app/pages/product/add-custom-product/add-custom-product-routing.module.ts");
      /* harmony import */


      var _add_custom_product_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./add-custom-product.page */
      "./src/app/pages/product/add-custom-product/add-custom-product.page.ts");
      /* harmony import */
      ...
      var AddCustomProductPageModule = function AddCustomProductPageModule() {
        _classCallCheck(this, AddCustomProductPageModule);
      };

      AddCustomProductPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], _angular_router__WEBPACK_IMPORTED_MODULE_8__["RouterModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClientModule"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _add_custom_product_routing_module__WEBPACK_IMPORTED_MODULE_5__["AddCustomProductPageRoutingModule"]],
    ...
    /***/
    function srcAppPagesProductAddCustomProductAddCustomProductPageScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppPagesProductAddCustomProductAddCustomProductPageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "AddCustomProductPage", function () {
        return AddCustomProductPage;
      });
      /* harmony import */
      ...
      var AddCustomProductPage = /*#__PURE__*/function () {
        function AddCustomProductPage(loading, camera, formBuilder, router, product) {
          _classCallCheck(this, AddCustomProductPage);
        ...
        _createClass(AddCustomProductPage, [{
          key: "ionViewWillEnter",
          value: function ionViewWillEnter() {//this.getCategoryProducts();
          }
        }, {
          key: "doRefresh",
          ...
          value: function takePhoto() {
            ...
            this.camera.getPicture({
              ...
              _this.addCustomProductForm.controls.image.setValue(imageData ? imageData : '');
            }, function (err) {
              console.log(err);

              _this.loading.presentToastWarning(err); // Handle error
          ...
          value: function getPhoto() {
            ...
            this.camera.getPicture({
              ...
              _this2.image = dataImage;

              _this2.addCustomProductForm.controls.image.setValue(dataImage ? dataImage : '');
            }, function (err) {// Handle error
            });
          }
        }, {
          key: "addCustomProduct",
          value: function addCustomProduct() {
            var _this3 = this;

            console.log(this.addCustomProductForm.value);
            this.loading.present();
            this.product.addCustomProduct(this.addCustomProductForm.value).subscribe(function (data) {
              console.log(data);

              _this3.loading.dismiss();

              if (data.type == 'success') {
                _this3.loading.presentToastSuccess(data.msg);

                _this3.router.navigateByUrl('/dashboard');
              }

              if (data.type == 'error') {
                _this3.loading.presentToastError(data.msg); //this.router.navigateByUrl('/employee-list');
      ...
      AddCustomProductPage.ctorParameters = function () {
        return [{
      ...
      AddCustomProductPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-add-custom-product',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! raw-loader!./add-custom-product.page.html */
        "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/product/add-custom-product/add-custom-product.page.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./add-custom-product.page.scss */
        "./src/app/pages/product/add-custom-product/add-custom-product.page.scss"))["default"]]
      })], AddCustomProductPage);
      /***/
    }
  }]);
})();
//# sourceMappingURL=pages-product-add-custom-product-add-custom-product-module-es5.js.map