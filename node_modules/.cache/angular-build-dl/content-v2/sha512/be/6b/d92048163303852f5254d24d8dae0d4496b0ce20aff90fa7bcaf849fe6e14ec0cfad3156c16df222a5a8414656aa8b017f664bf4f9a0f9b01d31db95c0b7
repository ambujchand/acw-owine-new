(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-product-product-details-product-details-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppPagesProductProductDetailsProductDetailsPageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppPagesProductProductDetailsProductDetailsRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppPagesProductProductDetailsProductDetailsModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      ProductDetailsPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], _angular_router__WEBPACK_IMPORTED_MODULE_7__["RouterModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_8__["HttpClientModule"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _product_details_routing_module__WEBPACK_IMPORTED_MODULE_5__["ProductDetailsPageRoutingModule"]],
    ...
    /***/
    function srcAppPagesProductProductDetailsProductDetailsPageScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppPagesProductProductDetailsProductDetailsPageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var ProductDetailsPage = /*#__PURE__*/function () {
        function ProductDetailsPage(loading, router, formBuilder, product) {
        ...
        _createClass(ProductDetailsPage, [{
          key: "checkCatId",
          value: function checkCatId() {
            if (this.productDetails) {} else {
          ...
          key: "updateSoldQty",
          value: function updateSoldQty() {
            var _this = this;

            if (this.formData.sold_qty > 0) {
              this.loading.present();
              this.product.updateSoldQty(this.formData).subscribe(function (data) {
                _this.loading.dismiss();

                console.log(data);

                if (data.success) {
                  _this.loading.presentToastSuccess(data.success);

                  _this.productDetails.qty = data.data;
                }

                if (data.error) {
                  _this.loading.presentToastError(data.error);
                }
              }, function (onerror) {
                if (onerror.status == 0) {
      ...
      ProductDetailsPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/product/product-details/product-details.page.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./product-details.page.scss */
        "./src/app/pages/product/product-details/product-details.page.scss"))["default"]]
      })], ProductDetailsPage);
      /***/
    }
  }]);
})();
//# sourceMappingURL=pages-product-product-details-product-details-module-es5.js.map