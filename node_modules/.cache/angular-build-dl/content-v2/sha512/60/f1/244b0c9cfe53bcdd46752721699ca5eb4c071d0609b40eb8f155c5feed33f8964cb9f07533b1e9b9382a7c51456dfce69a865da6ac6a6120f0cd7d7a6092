...
/* harmony import */ var _order_tracking_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./order-tracking.page */ "./src/app/pages/order/order-tracking/order-tracking.page.ts");
...
/* harmony import */ var _order_tracking_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./order-tracking-routing.module */ "./src/app/pages/order/order-tracking/order-tracking-routing.module.ts");
/* harmony import */ var _order_tracking_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./order-tracking.page */ "./src/app/pages/order/order-tracking/order-tracking.page.ts");
...
OrderTrackingPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            ...
            _order_tracking_routing_module__WEBPACK_IMPORTED_MODULE_5__["OrderTrackingPageRoutingModule"]
        ],
...
let OrderTrackingPage = class OrderTrackingPage {
    ...
    getOrderDetails() {
        if (this.order_id != undefined) {
            ...
            this.orders.getOrderStatus(formData).subscribe(data => {
                console.log(data);
...
OrderTrackingPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./order-tracking.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/order/order-tracking/order-tracking.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./order-tracking.page.scss */ "./src/app/pages/order/order-tracking/order-tracking.page.scss")).default]
    })
], OrderTrackingPage);
...
//# sourceMappingURL=pages-order-order-tracking-order-tracking-module-es2015.js.map