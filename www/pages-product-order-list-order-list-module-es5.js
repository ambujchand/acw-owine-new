(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-product-order-list-order-list-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppPagesProductOrderListOrderListPageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppPagesProductOrderListOrderListRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppPagesProductOrderListOrderListModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppPagesProductOrderListOrderListPageScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppPagesProductOrderListOrderListPageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var OrderListPage = /*#__PURE__*/function () {
        function OrderListPage(loading, formBuilder, router) {
          _classCallCheck(this, OrderListPage);

          this.loading = loading;
          this.formBuilder = formBuilder;
          this.router = router; //localStorage.removeItem('orderDetails');
          ...
          if (this.router.getCurrentNavigation().extras.state) {
            ...
            var ifData = JSON.parse(localStorage.getItem('orderDetails'));
            var data;
        ...
        _createClass(OrderListPage, [{
          ...
          key: "changeQty",
          value: function changeQty(value, id) {
          ...
          key: "orderCheckoutPage",
          value: function orderCheckoutPage() {
      ...
      OrderListPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/product/order-list/order-list.page.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./order-list.page.scss */
        "./src/app/pages/product/order-list/order-list.page.scss"))["default"]]
      })], OrderListPage);
      /***/
    }
  }]);
})();
//# sourceMappingURL=pages-product-order-list-order-list-module-es5.js.map